...
class SurveyWorkflow(grok.View):
    ...
    def sendMail(self, subject, mailbody, send_to,
                 send_to_bcc=[], sender=None, debug_mode=False):
        notify_encode = 'utf-8'
        ...
        try:
            if debug_mode:
                ...
                try:
                    ...
                    # BBB: Plone 2.5 has problem sending MIMEMultipart...
                    # fallback to normal plain text email
