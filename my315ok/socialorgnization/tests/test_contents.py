...
class Allcontents(unittest.TestCase):
    ...
    def setUp(self):
        ...
        portal.invokeFactory(
            'my315ok.socialorgnization.orgnizationfolder',
            'orgnizationfolder1')
        portal.invokeFactory(
            'my315ok.socialorgnization.shaoshanshifolder',
            'shaoshanshi')
        portal.invokeFactory(
            'my315ok.socialorgnization.xiangxiangshifolder',
            'xiangxiangshi')
        portal.invokeFactory(
            'my315ok.socialorgnization.xiangtanxianfolder',
            'xiangtanxian')
        portal.invokeFactory(
            'my315ok.socialorgnization.yuetangqufolder',
            'yuetangqu')
        portal.invokeFactory(
            'my315ok.socialorgnization.yuhuqufolder', 'yuhuqu')
        portal.invokeFactory(
            'my315ok.socialorgnization.shibenjifolder',
            'shibenji')
...
#         portal.invokeFactory('my315ok.socialorgnization.page', 'page')
        ...
        portal['orgnizationfolder1'].invokeFactory(
            'my315ok.socialorgnization.orgnization', 'orgnization2')
        portal['orgnizationfolder1'].invokeFactory(
            'my315ok.socialorgnization.orgnization', 'orgnization3')
    ...
    def test_folder_types(self):
        self.assertEqual(
            self.portal['orgnizationfolder1'].id,
            'orgnizationfolder1')
    ...
    def test_item_types(self):
        self.assertEqual(
            self.portal['orgnizationfolder1']['orgnization1'].id,
            'orgnization1')
        self.assertEqual(
            self.portal['orgnizationfolder1']['government1'].id,
            'government1')
        self.assertEqual(
            self.portal['orgnizationfolder1']['orgnization1']['orgnizationsurvey1'].id,
            'orgnizationsurvey1')
        self.assertEqual(
            self.portal['orgnizationfolder1']['orgnization1']['orgnizationadministrative1'].id,
            'orgnizationadministrative1')
