...
class CatalogSetupTest(unittest.TestCase):
    ...
    def test_conversation_total_comments(self):
        ...
        self.assertEqual(
            catalog.indexer_orgnization_registercode(p1)(),
            "8341")

        self.assertEqual(
            catalog.indexer_orgnization_orgnizationtype(p1)(),
            "minfei")
        self.assertEqual(
            catalog.indexer_orgnization_announcementtype(p1)(),
            "dengji")
        self.assertEqual(
            catalog.indexer_orgnization_belondtoarea(p1)(),
            "yuhuqu")
        self.assertEqual(
            catalog.indexer_orgnization_passdate(p1)(),
            "2013-09-18")
