...
#        self.assertTrue(outstr in browser.contents)
    ...
    def test_orgnizaton_view(self):
        ...
        import transaction
        transaction.commit()
        obj = portal['orgnizationfolder1']['orgnization1'].absolute_url() + \
            '/@@view'
        browser.open(obj)
...
#        outstr = outstr.decode('utf-8')  # plone output page use utf-8
    ...
    def test_orgnization_administrative_view(self):
        ...
        import transaction
        transaction.commit()
        obj = portal['orgnizationfolder1']['orgnization1']['orgnizationadministrative1'].absolute_url(
        ) + '/@@view'
#        import pdb
#        pdb.set_trace()
        browser.open(obj)
    ...
    def test_orgnizations_administrative_view(self):
        ...
        import transaction
        transaction.commit()
        obj = portal['orgnizationfolder1'].absolute_url() + \
            '/@@orgnizations_administrative'
        browser.open(obj)
        outstr = "oRollV1"
        self.assertTrue(outstr in browser.contents)
