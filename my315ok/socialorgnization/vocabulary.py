...
announcement_type_terms = [
    SimpleTerm(
        value,
        token,
        title) for value,
    token,
    title in announcement_type]
...
organization_type_terms = [
    SimpleTerm(
        value,
        token,
        title) for value,
    token,
    title in organization_type]
...
annualsurvey_result_terms = [
    SimpleTerm(
        value,
        token,
        title) for value,
    token,
    title in annualsurvey_result]
...
audit_item_terms = [SimpleTerm(value, token, title)
                    for value, token, title in audit_item]
